...
\begin{cventries}
    ...
    \cventry
        ...
        \begin{cvitems} % Description(s) bullet points
            ...
            \item Thesis: \emph{Advancements in PDFs determination: Incorporation of QED effects and new theoretical improvements in a modern deep learning fitting framework}. \href{https://hdl.handle.net/2434/1115085}{\textcolor{awesome}{{\textbf{link}}}}
        \end{cvitems}
        }
