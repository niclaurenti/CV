...
\begin{cventries}
    ...
    \cventry
        ...
        \begin{cvitems} % Description(s) bullet points
            ...
            \item Thesis: \emph{Construction of a next-to-next-to-next-to-leading order approximation for heavy flavour production in deep inelastic scattering with quark masses}. \href{https://inspirehep.net/literature/2750247}{\textcolor{awesome-red}{\aiicon{inspire}}}
        \end{cvitems}
        }
