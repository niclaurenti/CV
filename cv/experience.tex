...
%---------------------------------------------------------
    ...
    {Oct.\ 2021 - Sept.\ 2024}
    {
        \begin{cvitems} % Description(s) of tasks/responsibilities
            ...
            \item[] \textbf{\textcolor{awesome-red}{Tec}hnologies}: \pythonlogo{}~Python, \numpylogo{}~Numpy, \scipylogo{}~Scipy, \matplotliblogo{}~Matplotlib{}, \keraslogo{}~Keras, \tensorflowlogo{}~Tensorflow, \numbalogo{}~Numba, \fortranlogo{}~Fortran, \bashlogo{}~Bash, \gitlogo{}~Git, \githublogo{}~Github, \slurmlogo{}~Slurm, \pbslogo{}~PBS, \mathematicalogo{}~Mathematica, \linuxlogo{}~Linux, \faApple{}~MacOS, \vscodelogo{}~VS Code, \vimlogo{}~Vim, \latexlogo{}~Latex, \sqlitelogo{}~SQLite
        \end{cvitems}
    }
