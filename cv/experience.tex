...
%---------------------------------------------------------
    ...
    {Oct.\ 2024 - Current}
    {
        \begin{cvitems} % Description(s) of tasks/responsibilities
            ...
            \item Translated high-level system requirements into detailed low-level software specifications, developed software components written mainly in \texttt{C++}, \texttt{Java} and \texttt{Ada} and then designed, performed and automatized corresponding test procedures.
...
%---------------------------------------------------------
    ...
    {Oct.\ 2021 - Sept.\ 2024}
    {
        \begin{cvitems} % Description(s) of tasks/responsibilities
            ...
            \item Published research results in various papers and presented them at international conferences.
            \item[] \textbf{\textcolor{awesome}{Tec}hnologies}: \pythonlogo{}~Python, \numpylogo{}~Numpy, \scipylogo{}~Scipy, \matplotliblogo{}~Matplotlib{}, \keraslogo{}~Keras, \tensorflowlogo{}~Tensorflow, \numbalogo{}~Numba, \fortranlogo{}~Fortran, \bashlogo{}~Bash, \gitlogo{}~Git, \githublogo{}~Github, \githubactionslogo{}~GitHub Actions, \yamllogo{}~YAML, \jsonlogo{}~JSON, \slurmlogo{}~Slurm, \pbslogo{}~PBS, \mathematicalogo{}~Wolfram Mathematica, \linuxlogo{}~Linux, \faApple{}~MacOS, \vscodelogo{}~VS Code, \vimlogo{}~Vim, \latexlogo{}~Latex, \SQLlogo{}~SQL, \sqlitelogo{}~SQLite
        \end{cvitems}
    }
...
%---------------------------------------------------------
    ...
    {Mar.\ 2021 - Oct.\ 2021}
    {
        \begin{cvitems} % Description(s) of tasks/responsibilities
            ...
            \item Wrote from zero the \texttt{C++} library \texttt{Adani} \href{https://github.com/niclaurenti/adani}{\githublogo}, with the \texttt{Python} bindings available in the \href{https://pypi.org/project/adani/}{PyPI} and in \href{https://anaconda.org/conda-forge/adani}{conda-forge}, resulting in a published paper and presentations at international conferences.
            \item[] \textbf{\textcolor{awesome}{Tec}hnologies}: \cpplogo{}~C++, \gnulogo{}~GSL, \mathematicalogo{}~Wolfram Mathematica, \linuxlogo{}~Linux, \bashlogo{}~Bash, \cmakelogo{}~CMake, \emacslogo{}~Emacs, \latexlogo{}~Latex
        \end{cvitems}
    }
